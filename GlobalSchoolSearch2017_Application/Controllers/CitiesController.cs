...
namespace GlobalSchoolSearch2017_Application.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CityId,CityName,CountryName")] City city)
        {
            ...
            ViewBag.CountryName = new SelectList(db.Countries, "CountryName", "CountryName", city.CountryName);
            return View(city);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CityId,CityName,CountryName")] City city)
        {
            if (ModelState.IsValid)
            {
